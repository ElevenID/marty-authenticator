...
class TotpHotpQrFixtures {
  ...
  static List<String> allTotpHotp() {
    return [totpBasic(), totpCustom(), hotpBasic(), steamGuard()];
  }
}
...
class SpruceQrFixtures {
  ...
  static Map<String, String> testScenarios() {
    return {
      ...
      'presentation_request_multiple':
          W3cPresentationQrFixtures.multiCredentialRequest(),
