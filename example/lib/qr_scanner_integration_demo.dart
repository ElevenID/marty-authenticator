...
import 'package:privacyidea_authenticator/views/credential_selection_view.dart';
...
class _QrScannerIntegrationDemoState
            ...
            child: Column(
              ...
              children: [
                ...
                if (_lastScannedCode != null) ...[
                  ...
                  Builder(
                    builder: (context) {
                      final scannedPreview = _lastScannedCode!.length > 50
                          ? '${_lastScannedCode!.substring(0, 50)}...'
                          : _lastScannedCode!;

                      return Text(
                        'Last scanned: $scannedPreview',
  ...
  Future<void> _simulatePresentationRequest() async {
    ...
    try {
      ...
      await _handleScannedCode(jsonEncode(mockPresentationRequest));
    } catch (e) {
      setState(() {
  ...
  Future<void> _simulateCredentialOffer() async {
    ...
    try {
      ...
      await _handleScannedCode(jsonEncode(mockCredentialOffer));
    } catch (e) {
      setState(() {
