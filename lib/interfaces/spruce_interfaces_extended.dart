...
abstract class ISpruceIdPlatformServiceExtended extends ISpruceIdPlatformService {
  ...
  Future<Map<String, dynamic>> createPresentationSDK({
    ...
    required Map<String, List<String>> selectiveDisclosure, // credential_id -> disclosed_claims
    String? keyId,
  });
  ...
  Future<List<Map<String, dynamic>>> batchProcessCredentialsSDK({
    required List<Map<String, dynamic>> operations, // operation_type, credential, params
    String? keyId,
  });
  
  /// Get credential metadata and capabilities
  /// Provides detailed information about credential formats and supported operations
  Future<Map<String, dynamic>> getCredentialCapabilitiesSDK(String credentialId);
  ...
  Future<Stream<Map<String, dynamic>>> monitorCredentialStatusSDK(String credentialId);
