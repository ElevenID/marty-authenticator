...
enum PrivacyLevel {
  minimal(Icons.shield, Colors.green, 'Minimal disclosure'),
  moderate(Icons.verified_user, Colors.orange, 'Moderate disclosure'),
  full(Icons.warning, Colors.red, 'Full disclosure');

  const PrivacyLevel(this.icon, this.color, this.description);
  final IconData icon;
  final Color color;
