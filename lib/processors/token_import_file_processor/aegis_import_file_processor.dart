      ...
      try {
        ...
        final otpAuthMap = validateMap<String>(
          ...
          validators: {
            ...
            OTPToken.SECRET_BASE32: ObjectValidator<String>(
            ...
            OTPToken.DIGITS: ObjectValidatorNullable<String>(
              transformer: (v) => (v as int).toString(),
            ),
            TOTPToken.PERIOD_SECONDS: ObjectValidatorNullable<String>(
              transformer: (v) => (v as int).toString(),
            ),
            HOTPToken.COUNTER: ObjectValidatorNullable<String>(
              transformer: (v) => (v as int).toString(),
            ),
          },
          name: 'aegisV2Entry',
      ...
      try {
        ...
        final otpAuthMap = validateMap<String>(
          ...
          validators: {
            ...
            OTPToken.SECRET_BASE32: ObjectValidator<String>(
              transformer: (v) =>
                  Encodings.base32.encodeStringTo(Encodings.base32, v),
            ),
            OTPToken.ALGORITHM: const ObjectValidatorNullable<String>(),
