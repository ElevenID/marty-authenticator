...
class MdocTokenClass(TokenClass):
    ...
    def get_class_info(key=None, ret="all"):
        ...
        info = {
            ...
            "title": _("mDoc Token"),
            "description": _(
                "Mobile document credential token using ISO 18013-5 and OID4VCI"
            ),
            "init": {},
            "config": {},
            "user": ["enroll"],
    ...
    def __init__(self, db_token):
        ...
        if SSI_AVAILABLE:
            ...
            log.warning(
                "SSI Python bindings not available. Install ssi-python package."
            )
