        ...
        move || {
            ...
            move |context| {
                transform_result_dco::<_, _, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::create_selectable_credential(
                        api_credential,
                        api_privacy_level,
                    ))?;
                    std::result::Result::Ok(output_ok)
...
fn wire__crate__api__evaluate_presentation_request_impl(
    ...
    _credentials: impl CstDecode<Vec<crate::credential::Credential>>,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
        ...
        move || {
            ...
            let api__credentials = _credentials.cst_decode();
            move |context| {
                transform_result_dco::<_, _, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
...
fn wire__crate__api__evaluate_service_presentation_policy_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    request_json: impl CstDecode<String>,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "evaluate_service_presentation_policy",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_dco::<_, _, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok =
                            crate::api::evaluate_service_presentation_policy(api_request_json)?;
                        std::result::Result::Ok(output_ok)
                    })(),
                )
            }
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_dco::<_, _, ()>((move || {
                    let output_ok =
                        Ok::<_, ()>(crate::api::get_credential_claims(&api_credential))?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_dco::<_, _, ()>((move || {
                    let output_ok =
                        Ok::<_, ()>(crate::api::group_credentials_by_issuer(api_credentials))?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_dco::<_, _, ()>((move || {
                    let output_ok =
                        Ok::<_, ()>(crate::api::is_credential_expired(&api_credential))?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__biometrics__shutdown_biometrics_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "shutdown_biometrics",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            move |context| {
                transform_result_dco::<_, _, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok = crate::biometrics::shutdown_biometrics()?;
                        std::result::Result::Ok(output_ok)
                    })(),
                )
            }
...
fn wire__crate__api__zk_is_supported_on_device_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        ...
        move || {
            move |context| {
                transform_result_dco::<_, _, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::zk_is_supported_on_device())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
mod io {
    ...
    pub extern "C" fn frbgen_marty_authenticator_wire__crate__api__evaluate_presentation_request(
        ...
        _credentials: *mut wire_cst_list_credential,
    ) {
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_marty_authenticator_wire__crate__api__evaluate_service_presentation_policy(
        port_: i64,
        request_json: *mut wire_cst_list_prim_u_8_strict,
    ) {
        wire__crate__api__evaluate_service_presentation_policy_impl(port_, request_json)
    }
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_marty_authenticator_wire__crate__biometrics__shutdown_biometrics(
        port_: i64,
    ) {
        wire__crate__biometrics__shutdown_biometrics_impl(port_)
    }
...
mod web {
    ...
    pub fn wire__crate__api__evaluate_presentation_request(
        ...
        _credentials: flutter_rust_bridge::for_generated::wasm_bindgen::JsValue,
    ) {
        wire__crate__api__evaluate_presentation_request_impl(
            port_,
            request_json,
    ...
    #[wasm_bindgen]
    pub fn wire__crate__api__evaluate_service_presentation_policy(
        port_: flutter_rust_bridge::for_generated::MessagePort,
        request_json: String,
    ) {
        wire__crate__api__evaluate_service_presentation_policy_impl(port_, request_json)
    ...
    #[wasm_bindgen]
    pub fn wire__crate__biometrics__shutdown_biometrics(
        port_: flutter_rust_bridge::for_generated::MessagePort,
    ) {
        wire__crate__biometrics__shutdown_biometrics_impl(port_)
    }
